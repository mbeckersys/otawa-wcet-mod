...
# 158 "formatlexer.ml"
  ...
  | __ocaml_lex_state -> lexbuf.Lexing.refill_buff lexbuf; __ocaml_lex_formatSize_rec size indice liste lexbuf __ocaml_lex_state
...
# 204 "formatlexer.ml"
  ...
  | __ocaml_lex_state -> lexbuf.Lexing.refill_buff lexbuf; __ocaml_lex_formatClass_rec lexbuf __ocaml_lex_state
...
# 245 "formatlexer.ml"
  ...
  | __ocaml_lex_state -> lexbuf.Lexing.refill_buff lexbuf; __ocaml_lex_formatCode_rec acc lexbuf __ocaml_lex_state
