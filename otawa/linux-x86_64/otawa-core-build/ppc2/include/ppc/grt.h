...
#define __PPC_CSIZE(t)			(sizeof((t)(1) + 1) * 8)
#define __PPC_EXTS(n, e)			(((e) << (n)) >> (n))
#define __PPC_EXTS8(n, e)			__PPC_EXTS(__PPC_CSIZE( int8_t) -  8 + (n), (e))
#define __PPC_EXTS16(n, e)		__PPC_EXTS(__PPC_CSIZE(int16_t) - 16 + (n), (e))
#define __PPC_EXTS32(n, e)		__PPC_EXTS(__PPC_CSIZE(int32_t) - 32 + (n), (e))
#define __PPC_EXTS64(n, e)		__PPC_EXTS(__PPC_CSIZE(int64_t) - 64 + (n), (e))
//#define __PPC_EXTS8(n, e)			(((-1L ) << ( 8 - (n)))|(e))
//#define __PPC_EXTS16(n, e)		(((-1L ) << (16 - (n)))|(e))
//#define __PPC_EXTS32(n, e)		(((-1L ) << (32 - (n)))|(e))
//#define __PPC_EXTS64(n, e)		(((-1LL) << (64 - (n)))|(e))
