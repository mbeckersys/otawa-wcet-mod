...
let rec scanner out dict state lexbuf =
  lexbuf.Lexing.lex_mem <- Array.create 4 (-1) ;   __ocaml_lex_scanner_rec out dict state lexbuf 0
...
# 444 "templater.ml"
  ...
  | __ocaml_lex_state -> lexbuf.Lexing.refill_buff lexbuf; __ocaml_lex_scanner_rec out dict state lexbuf __ocaml_lex_state
...
# 460 "templater.ml"
  ...
  | __ocaml_lex_state -> lexbuf.Lexing.refill_buff lexbuf; __ocaml_lex_comment_rec out dict state lexbuf __ocaml_lex_state
...
# 502 "templater.ml"
  ...
  | __ocaml_lex_state -> lexbuf.Lexing.refill_buff lexbuf; __ocaml_lex_skip_rec out dict cnt lexbuf __ocaml_lex_state
...
# 564 "templater.ml"
  ...
  | __ocaml_lex_state -> lexbuf.Lexing.refill_buff lexbuf; __ocaml_lex_scan_end_rec buf cnt lexbuf __ocaml_lex_state
